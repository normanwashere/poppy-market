...
export async function initializeScheduler() {
    ...
    calendarInstance = new FullCalendar.Calendar(calendarEl, {
        ...
        // --- Event Listener Setup for Scheduler Modals and Actions (Inline and Correctly Scoped) ---
        // Checks added to prevent duplicate listeners if initializeScheduler is called multiple times.
