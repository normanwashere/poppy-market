...
// These define the persistent state of the dashboard table and filtering
...
export function setupDashboardPage() {
    ...
    // Helper functions are now defined INSIDE setupDashboardPage or its nested functions
    // to ensure they have access to the necessary DOM elements and current 'role'.

    // Admin Dashboard Initialization (INTERNAL to setupDashboardPage)
    function initializeAdminDashboard() {
        ...
        // Now call the main logic runner for this dashboard role
        runDashboardLogic('admin');
    }

    // Seller Dashboard Initialization (INTERNAL to setupDashboardPage)
    ...
    // This is INTERNAL to setupDashboardPage's scope.
    ...
    // This is the function exported and called by main.js
    export function setupDashboardPage() {
        const container = document.getElementById('dashboard-container');
        if (!container) {
            console.error("Dashboard container not found in setupDashboardPage.");
